    ...
    return (
        <>
            ...
            <div className={classes.main_text}>
                <h1>{ props.title }</h1>
            This is the Contact page. To be honest, I should put something interesting here, but instead I'm going to tell you about 
                    my super awesome <a href="https://react-carcollectionsh.web.app">Car Collection App</a>.
            </div>
            </div>
            <Footer />
